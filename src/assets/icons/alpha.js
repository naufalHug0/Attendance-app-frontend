...
const ALPHA_ICON = ({
    ...
    className,
    ...rest
}) => <svg {...rest} xmlns="http://www.w3.org/2000/svg" width={size} fill="currentColor" class={`bi bi-clipboard2-x-fill ${className}`} viewBox="0 0 16 16">
